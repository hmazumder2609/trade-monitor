...
export class InsightsPanel extends Panel {
  ...
  async sendMessage(text: string): Promise<void> {
    ...
    try {
      ...
      if (!apiKey) {
        // Format raw data into a readable briefing without LLM
  ...
  /** Format raw tool output into a readable summary when no LLM is available */
  ...
  async refresh(): Promise<void> {
    /* Interactive panel, no auto-refresh */
  }
}
